                ...
                <div class="home-tab">
                  <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link " id="profile-tab" data-bs-toggle="tab" href="#audiences" role="tab" aria-selected="audiences">Data Products</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#demographics" role="tab" aria-selected="demographics">Data Suppliers</a>
                      </li>
                      <li class="nav-item">
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <div class="text-light col-md-6 col-lg-12 grid-margin stretch-card">
                          <div class="text-light card bg-secondary card-rounded">
                                <div class="card-body pb-0">
                            <center><p class="text-light statistics-title">Total User</p>
                              <h3>{{$totaluser}}</h3>
                              <a href="/user" class="text-light btn btn-primary">View User Data</a>
                          ...
                          <div class="row flex-grow">
                            <div class="text-light col-md-6 col-lg-12 grid-margin stretch-card">
                              <div class="text-light card bg-primary card-rounded">
                                <div class="card-body pb-0">
                            <center><p class="text-light statistics-title">Total Products</p>
                              <h3>{{$totalproduk}}</h3>
                              <a href="/produk" class="text-light btn btn-info">View Product Data</a>
                         ...
                         <div>
                          ...
                          <div class="row flex-grow">
                            <div class="text-light col-md-6 col-lg-12 grid-margin stretch-card">
                              <div class="text-light card bg-danger card-rounded">
                                <div class="card-body pb-0">
                            <center><p class="text-light statistics-title">Total Suppliers</p>
                              <h3>{{$totalsupplier}}</h3>
                              <a href="/supplier" class="text-light btn btn-success">View Supplier Data</a>
                         ...
                         <div>
                          ...
                          <div class="row flex-grow">
                            <div class="text-light col-md-6 col-lg-12 grid-margin stretch-card">
                              <div class="text-light card bg-info card-rounded">
                                <div class="card-body pb-0">
                            <center><p class="text-light statistics-title">Total Sales</p>
                              <h3>{{$totalpenjualan}}</h3>
                              <a href="/penjualan" class="text-light btn btn-danger">View Sales Data</a>
